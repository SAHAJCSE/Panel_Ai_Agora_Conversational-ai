...
export function MorphingSpinner({ size = "md", className }: MorphingSpinnerProps) {
  ...
  return (
    <div className={cn("relative flex items-center justify-center", sizeClasses[size], className)}>
      <div className="absolute inset-0 animate-[smoothMorph_3s_ease-in-out_infinite] bg-gradient-to-tr from-[#ec4899] via-[#a855f7] to-[#ec4899] shadow-[0_0_25px_rgba(236,72,153,0.5)]" />

      ...
      fontFamily: {
        ...
        // Without it, hsl(var(--token)) can't accept an alpha channel at utility-class time.
  		...
  		animation: {
  			...
  			'glow-rotate': 'glow-rotate 6s linear infinite',
  			'glow-pulse': 'glow-pulse 3s ease-in-out infinite',
  			'waveform-bounce': 'waveform-bounce 0.8s ease-in-out infinite alternate',
  			'handoff-slide': 'handoff-slide 0.5s cubic-bezier(0.22,1,0.36,1)',
